...
document.addEventListener('DOMContentLoaded', () => {
	...
	if (currentPage !== 'profile.html' && currentPage !== 'cart.html') {
        ...
        // hidden slider and products at the start
    ...
    const btnBoardGames = document.getElementById('btn-boardgames');
